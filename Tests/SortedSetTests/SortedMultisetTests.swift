...
final class SortedMultisetTests: XCTestCase {
    ...
    func testInitRange() throws {
        let set = SortedMultiset<Int>(0 ..< 10000)
    ...
    func testInitCollection2() throws {
        let set = SortedMultiset<Int>([2,3,3,0,0,1,1,1])
        XCTAssertEqual(set.buckets.flatMap{$0}, [0,0,1,1,1,2,3,3])
        XCTAssertEqual(set.count, 8)
        XCTAssertFalse(set.isEmpty)
    }
    
    func testRemove() throws {
        var set = SortedMultiset<Int>([0,1,2,3,4])
    ...
    func testArrayAccess() throws {
        let set = SortedMultiset<Int>([0,1,2,3,4])
